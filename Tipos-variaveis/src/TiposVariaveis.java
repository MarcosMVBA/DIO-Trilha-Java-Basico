public class TiposVariaveis {
    public static void main(String[] args) throws Exception {
        ...
        // Caso quiser que o valor determinado não seja alterado, basta colocar o "final" antes da variavel em questão. O PI por exemplo, ele vale 3,14 é um valor que não muda, ficaria da seguinte forma
